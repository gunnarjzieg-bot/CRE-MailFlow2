      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 lg:pt-32 lg:pb-24 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            Generate smart, personalized postcards in seconds. Enter your buying criteria, and our system designs the mailer, writes the copy, and handles printing and delivery.
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              onClick={onStart}
              className="px-8 py-4 bg-primary text-white text-lg font-semibold rounded-lg shadow-lg hover:bg-blue-800 transition transform hover:-translate-y-0.5"
            >
              Start Your Campaign
            </button>
          </div>
          ...
          <div className="mt-12 flex items-center justify-center space-x-2 text-sm text-gray-500">
             <div className="flex -space-x-2">
                <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?fit=crop&w=100&h=100" alt=""/>
                <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?fit=crop&w=100&h=100" alt=""/>
                <img className="inline-block h-8 w-8 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?fit=crop&w=100&h=100" alt=""/>
             </div>
